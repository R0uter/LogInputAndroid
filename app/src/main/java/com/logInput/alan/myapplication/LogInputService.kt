 ...
 */
class LogInputService : InputMethodService() {
    ...
    private lateinit var mSymbolsKeyboard: LatinKeyboard
    private lateinit var mSymbolsShiftedKeyboard: LatinKeyboard
    private var mQwertyKeyboard: LatinKeyboard? = null
    private lateinit var mCurKeyboard: LatinKeyboard
    ...
    private val mListener = object :KeyboardView.OnKeyboardActionListener{
        ...
        override fun onKey(primaryCode: Int, keyCodes: IntArray?) {
            when {
                ...
                primaryCode == Keyboard.KEYCODE_MODE_CHANGE && mInputView != null ->{
                    ...
                    if(keyCodes != null) handleCharacter(primaryCode,keyCodes)
                }
            }
        }
    ...
    override fun onCreateInputView(): View {
        ...
        mInputView!!.setOnKeyboardActionListener(mListener)
        setLatinKeyboard(mQwertyKeyboard!!)
    ...
    override fun onCreateCandidatesView(): View {
        mCandidateView = CandidateView(this ,this)
